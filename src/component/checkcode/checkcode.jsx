...
export default function Checkcode() {
  ...
  const onSubmit = (values, { setSubmitting }) => {
    ...
    axios
      .post("https://clean-green-agriculture.vercel.app/auth/verify-code", {
        OTP,
      })
      .then((response) => {
        setLoading(false);
  ...
  return (
    <>
      <div
        className={`d-flex justify-content-center align-items-center ${styles.signupContainer}`}
      >
        {/* <h5>Clean Green</h5> */}
              ...
              {({
                ...
                <Form>
                  <div className="d-flex justify-content-between">
                    {["digit1", "digit2", "digit3", "digit4", "digit5"].map(
                      (digit, index) => (
                        <Field
                          key={digit}
                          type="text"
                  ...
                  <button
                    ...
                    className={`btn btn-light w-100 ${styles.btnPrimary}`}
                  >
                    {loading ? (
                  ...
                  <div className={`text-center mt-3 ${styles.textWhite}`}>
                    Go back to
                    <Link to="/login" className={styles.textWarning}>
                      login
                    </Link>
                    <span>page</span>
                  </div>
